...
add.constraint(lprec, c(0,1,0,0,0,0), ">=", 295)

add.constraint(lprec, c(0,0,1,0,0,0), ">=", 188)

#add.constraint(lprec, c(0,0,0,1,0,0), ">=", 154)

add.constraint(lprec, c(0,0,0,0,1,0), ">=", 107)
